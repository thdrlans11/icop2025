...
<div class="trans-conbox">
    ...
    <div class="terminal-info-wrap">
        ...
        <div class="sub-tab-con js-tab-con" style="display: block;">
            <img src="/assets/image/sub/img_terminal01_v2.png" alt="Terminal 1">
        </div>
        <div class="sub-tab-con js-tab-con">
            <img src="/assets/image/sub/img_terminal02_v2.png" alt="Terminal 2">
        </div>
    </div>
    ...
    <p>
        Take the Airport Railroad (AREX) from Incheon International Airport Terminal 1 or 2. (You can choose either Express train or All stop train.) <br>
        Transfer to Line Number 4 (light blue line) at Seoul Station and get off at Hyehwa Station. <br>
    ...
    <div class="map-tit-wrap">
        <h4 class="map-tit">From Gimpo International Airport <img src="/assets/image/sub/ic_airport.png" alt=""></h4>
    </div>
    <h5 class="map-info-tit mt-0"><span>By Metro (approx. 90 minutes / 1,800 KRW)</span></h5>
    <p>
        You can also take the Airport Railroad from Gimpo International Airport and transfer at Seoul Station to Line Number 4 (light blue line) and get off at Hyehwa Station. <br>
        Or, you can take Line Number 5 (purple line) from the airport and transfer at Dongdaemun History & Culture Park Station to Line number 4 (line blue line) and get off at Hyehwa Station. <br>
        From Hyehwa Station, use the Exit # 1 and from there, you can walk to the venue or take a green bus #07 and get off at the 600 Years Anniversary Hall.
    </p>
