...
<div class="price-box">
    ...
    <div class="text-wrap">
        <strong class="tit">총 결제 금액 : <span class="text-orange totalPriceSpan"></span></strong>
        <p class="priceText">
        ...
        <li>
            ...
            <div class="form-con">
                <div class="radio-wrap cst">
                    @foreach( config('site.registration.payMethodKor') as $key => $val ) @if( $key == 'F' ) @continue @endif
...
<div class="write-wrap Bbox" {!! ( $apply->payMethod ?? '' ) != 'B' ? 'style="display:none"' : '' !!}>
    <ul>
        ...
        <li class="n2">
            <div class="form-tit">송금자명 <strong class="required">*</strong></div>
            <div class="form-con">
                <input type="text" name="payName" id="payName" value="{{ $apply->payName ?? '' }}" class="form-item">
            </div>
            <div class="form-tit">송금예정일 <strong class="required">*</strong></div>
            <div class="form-con">
...
<div class="border-box mt-40 Bbox" {!! ( $apply->payMethod ?? '' ) != 'B' ? 'style="display:none"' : '' !!}>
    ...
    <ul class="list-type list-type-dot">
        ...
        <li>등록자와 금인 이름이 다를 경우, 사무국으로 연락주시기 바랍니다. (icop2025org@gmail.com)</li>
    </ul>
</div>
...
<ul class="list-type list-type-dot">
    <li>등록 취소 시 반드시 이메일을 통하여 취소 내용을 사무국으로 접수해 주시기 바랍니다. (icop2025org@gmail.com)</li>
    ...
    <table class="cst-table">
        ...
        <tbody>
            <tr>
                <th scope="row">100%</th>
                <td>
                    <strong class="text-red">2025년 4월 30일 (수) 까지 취소 시</strong>
                </td>
            </tr>
            <tr>
                <th scope="row">No Refund</th>
                <td>
                    <strong class="text-red">2025년 5월 1일 (목) 이후 취소 시</strong>
                </td>
            </tr>
        </tbody>
    </table>
