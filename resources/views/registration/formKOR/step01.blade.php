...
<div class="sub-tit-wrap">
    <h4 class="sub-tit">개인정보입력</h4>
</div>
<ul class="write-wrap">
    <li>
        <div class="form-tit">국가 <strong class="required">*</strong></div>
        <div class="form-con">
            @if( !$apply )
    ...
    <li>
        ...
        <div class="form-con">
            ...
            <div class="form-group has-btn">
                ...
                <a href="#n" onclick="emailCheck();" class="btn btn-small color-type3">이메일 확인</a>
            </div>
            @else
            {{ $apply->email }}
            @endif
    ...
    <li>
        <div class="form-tit">성명 (영문) <strong class="required">*</strong></div>
        <div class="form-con">
    ...
    <li>
        <div class="form-tit">부서 <strong class="required">*</strong></div>
        <div class="form-con">
            <input type="text" name="department" id="department" value="{{ $apply->department ?? '' }}" class="form-item">
        </div>
    </li>
    <li>
        <div class="form-tit">소속 <strong class="required">*</strong></div>
        <div class="form-con">
            <input type="text" name="affiliation" id="affiliation" value="{{ $apply->affiliation ?? '' }}" class="form-item">
        </div>
    </li>
    <li>
        <div class="form-tit">연락처 <strong class="required">*</strong></div>
        <div class="form-con">
