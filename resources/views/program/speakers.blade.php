    ...
    <div class="invited-list">
        <div class="invited-conbox">
            <div class="invited-con">
                ...
                <div class="text-wrap">
                    <strong class="name"><a href="https://biology.ulsan.ac.kr/biology/1398" target="_blank"><u>Mann Kyoon Shin</u></a></strong>
                    <p>
                    ...
                    <ul class="list-type list-type-bar">
                        <li>Research Associate, Princeton University, Dept. of Ecology &amp; Evolution
                            (2000-2002)</li>
                        <li>Director, Cetacean Research Institute of UOU (2005- 2012)</li>
                        <li>Dean, Office of External Cooperation, UOU (2015-2017)</li>
            ...
            <div class="invited-con">
                ...
                <div class="text-wrap">
                    ...
                    <p>
                        ...
                        (AWI), Germany. Before joining the University of East Anglia (UEA) in 2007, most of his
                        PostDoc research was conducted with a fellowship from the German Academic Exchange
                        Service (DAAD) in the School of Oceanography, University of Washington (E.V. Armbrust
                        lab) in joint cooperation with the Biotechnology Center, University of Wisconsin (M.R.
                        Sussman lab), USA. Before he was promoted to Professor (Personal Chair) in 2014, he was
                        Reader (2012-2014) and had a Research Councils UK (RCUK) Academic Fellowship
                        (2007-2012). In 2019, Prof.&nbsp;Mock&nbsp;was appointed Guest Professor at the Ocean
                        University of China, and in 2024, he received the CAS President’s International
                        Fellowship (PIFI) at the Institute of Oceanology, Qingdao, China.
        ...
        <div class="invited-conbox">
            <div class="invited-con">
                <div class="img-wrap">
                    <img src="/assets/image/sub/img_gautamdey.png" alt="Gautam Dey">
                </div>
                <div class="text-wrap">
                    <strong class="name"><a href="https://evonuclab.org/people/gautam-dey-2cln4" target="_blank"><u>Gautam Dey</u></a> <a href="https://www.embo.org/funding/lecture-travel-and-childcare-grants/embo-young-investigator-lectures/" target="_blank"><span class="logo"><img src="/assets/image/sub/img_logo_embo.png" alt="EMBO"> EMBO young investigator lecture
                    </span></a></strong>
                    <p>
                        EMBL (European Molecular Biology Laboratory) <br>
                        Germany
                    </p>
                    <p class="tit"><span>Lecture Title: Evolution and diversity of mitosis</span> <button type="button" class="btn-toggle js-btn-toggle"></button></p>
                    <div class="abstract-con js-toggle-con">
                    ...
                    <p>
                        <!-- Postdoctoral Research Associate, Baum lab, UCL, 2015-2020 <br>
                        Marie Sklodowska-Curie Fellow, 2017-2018 <br>
                        PhD 2015, Chemical and Systems Biology, Stanford University <br>
        ...
        <div class="invited-conbox">
            <div class="invited-con">
                ...
                <div class="text-wrap">
                    <strong class="name"><a href="https://www.mpi-bremen.de/en/Greenhouse-Gases-Research-Group-2/Jana-Milucka.html" target="_blank"><u>Jana Milucka</u></a></strong>
                    <p>
        ...
        <div class="sub-tit-wrap text-center">
            <h4 class="sub-tit">Hutner Award Winner Presentation</h4>
        </div>
        <div class="invited-conbox">
            <div class="invited-con">
                <div class="img-wrap">
        ...
        <div class="invited-conbox">
            <div class="invited-con">
                ...
                <div class="text-wrap">
                    <strong class="name"><a href="https://research-portal.uea.ac.uk/en/persons/thomas-mock" target="_blank"><u>Laura Eme</u></a></strong>
                    <p>
        ...
        <div class="invited-conbox">
		 ...
		 <div class="invited-conbox">
            <div class="invited-con">
                <div class="img-wrap">
                    <img src="/assets/image/sub/img_Patrick-Keeling.png" alt="PatrickKeeling">
                </div>
                <div class="text-wrap">
                    <strong class="name"><a href="https://www3.botany.ubc.ca/keeling/" target="_blank"><u>Patrick Keeling</u></a></strong>
                    <p>
                        Professor<br>
