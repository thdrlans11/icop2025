...
class BoardService extends dbService
{
    ...
    public function upsert(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('board.list', ['code'=>$this->code])->withSuccess(($request->sid ? '수정' : '등록' ).'되었습니다.');
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('board.list', ['code'=>$this->code])->withSuccess('게시물이 삭제 되었습니다.');
    }
